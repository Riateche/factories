    ...
    pub fn load() -> anyhow::Result<Info> {
        ...
        let modules = [
            ...
            Module {
                ...
                type_: ModuleType::Quality,
                quality: 0.into(),
                energy_delta_percent: 0.,
                speed_delta_percent: -5.,
                productivity_delta_percent: 0.,
                quality_delta_percent: 1.,
            },
            Module {
                name: "quality-module-2".into(),
                type_: ModuleType::Quality,
                quality: 0.into(),
                energy_delta_percent: 0.,
                speed_delta_percent: -5.,
                productivity_delta_percent: 0.,
                quality_delta_percent: 2.,
            },
            Module {
                name: "quality-module-3".into(),
                type_: ModuleType::Quality,
                quality: 0.into(),
                energy_delta_percent: 0.,
                speed_delta_percent: -5.,
